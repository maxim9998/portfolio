...
const ContactMe = () => {
  ...
  return (
    <section className="w-full flex flex-col items-center justify-start xs:text-center px-10 gap-10 min-h-[76.2vh] pt-24 xs:py-14 overflow-x-hidden" id={getHref(ROUTE_NAMES["CONTACT_ME"])}>
